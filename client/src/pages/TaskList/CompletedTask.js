      ...
      >
        {tasks.map((project, key) => {
          ...
          return (
            <>
             {[
    { color: ['linear-gradient(90deg, hsla(332, 53%, 82%, 1) 0%, hsla(176, 57%, 89%, 1) 100%)', 'linear-gradient(to right, #ffa585, #ffeda0)', 'linear-gradient(to right, #ebf4f5, #b5c6e0)' ]},   
  ].map((item) => (
            <div className="card card-animate Tasks" 
            style={{ 
              width: "300px", 
              marginBottom: "30px", 
              borderRadius: "10px", 
