    ...
    <div className={styles.container}>
      <div>
        <div
          ...
          // }}
        >
          <Button to="/task" variant="contained" LinkComponent={Link}  className="task-btn" style={{marginBottom:"20px", background:"linear-gradient(130deg,  #ef96c5, #ccfbff )", color:"black"}}>
